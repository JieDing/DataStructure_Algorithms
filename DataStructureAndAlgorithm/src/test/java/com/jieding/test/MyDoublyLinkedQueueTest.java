...
import com.jieding.datastructure.MyDoublyLinkedQueue;

public class MyDoublyLinkedQueueTest extends TestCase {

	protected static void setUpBeforeClass() throws Exception {
	}

	public void testClear() {
		QueueADT<String> q = new MyDoublyLinkedQueue<String>();
		q.enqueue("abc");
		q.enqueue("bcd");
		q.clear();
